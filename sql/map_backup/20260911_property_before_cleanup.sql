...
INSERT INTO `property` (`id`, `pngid`, `blocking`, `footprint_w`, `footprint_h`, `min_gap`, `placeable`, `placement`, `view_note`, `action`, `action_type`, `value`, `bubble_text`) VALUES (4101,4101,1,2,5,0,0,'floor','洞府書櫃（左牆）',0,0,0,'');
INSERT INTO `property` (`id`, `pngid`, `blocking`, `footprint_w`, `footprint_h`, `min_gap`, `placeable`, `placement`, `view_note`, `action`, `action_type`, `value`, `bubble_text`) VALUES (4102,4102,1,1,1,0,0,'floor','白蘭花盆',0,0,0,'');
INSERT INTO `property` (`id`, `pngid`, `blocking`, `footprint_w`, `footprint_h`, `min_gap`, `placeable`, `placement`, `view_note`, `action`, `action_type`, `value`, `bubble_text`) VALUES (4103,4103,1,2,2,0,0,'floor','松樹盆景',0,0,0,'');
INSERT INTO `property` (`id`, `pngid`, `blocking`, `footprint_w`, `footprint_h`, `min_gap`, `placeable`, `placement`, `view_note`, `action`, `action_type`, `value`, `bubble_text`) VALUES (4104,4104,1,5,2,0,0,'floor','紅楓長盆',0,0,0,'');
INSERT INTO `property` (`id`, `pngid`, `blocking`, `footprint_w`, `footprint_h`, `min_gap`, `placeable`, `placement`, `view_note`, `action`, `action_type`, `value`, `bubble_text`) VALUES (4105,4105,1,5,2,0,0,'floor','靈石竹簡櫃',0,0,0,'');
INSERT INTO `property` (`id`, `pngid`, `blocking`, `footprint_w`, `footprint_h`, `min_gap`, `placeable`, `placement`, `view_note`, `action`, `action_type`, `value`, `bubble_text`) VALUES (4106,4106,1,1,1,0,0,'floor','直立綠植',0,0,0,'');
INSERT INTO `property` (`id`, `pngid`, `blocking`, `footprint_w`, `footprint_h`, `min_gap`, `placeable`, `placement`, `view_note`, `action`, `action_type`, `value`, `bubble_text`) VALUES (4107,4107,0,1,1,0,0,'floor','聚靈法陣',0,0,0,'');
...
-- Dump completed on 2026-09-11 14:49:07
