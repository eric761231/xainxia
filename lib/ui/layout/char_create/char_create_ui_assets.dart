...
abstract final class CharCreateUiAssets {
  ...
  // ── L4 底中名稱 ───────────────────────────────
  static const String inputContact = 'assets/ui/create_char/input_cotact.png';

  // ── 水墨按鈕 / 祥雲 label ─────────────────────
  /// 小筆刷底（legacy fallback）。
  static const String inkBtn01 = 'assets/ui/create_char/ink_btn01.png';

  /// 大筆刷底（legacy fallback）。
  static const String inkBtn02 = 'assets/ui/create_char/ink_btn02.png';

  /// 水墨底（靈根列、素質列、重置點數）。
  static const String inkBtn04 = 'assets/ui/create_char/ink_btn04.png';

  /// 水墨 label（legacy）。
  static const String inkLabel = 'assets/ui/create_char/ink_label.png';

  /// 祥雲 label（屬性分配、剩餘點數）。
  static const String cloudLabel01 = 'assets/ui/create_char/cloud_label01.png';

  /// 祥雲 label 鏡像（預載備用）。
  static const String cloudLabel02 = 'assets/ui/create_char/cloud_label02.png';

  /// 祥雲 label（預載，待指定用途）。
  static const String cloudLabel03 = 'assets/ui/create_char/cloud_label03.png';
  ...
  // ── 素質列 / 裝飾（legacy）──────────────────────
  static const String option = 'assets/ui/create_char/option.png';

  // ── L6 左上返回 ───────────────────────────────
  static const String backIcon = 'assets/ui/create_char/back_icon.png';
  static const String backIconHover =
      'assets/ui/create_char/back_icon_hover.png';
  static const String backIconPressed =
      'assets/ui/create_char/back_icon_pressed.png';

  // ── L3 右欄配點 ───────────────────────────────
  static const String spiritIcon = 'assets/ui/create_char/spirit_icon.png';
  static const String constitutionIcon =
      'assets/ui/create_char/constitution_icon.png';
  static const String agilityIcon = 'assets/ui/create_char/agility_icon.png';
  static const String intelIcon = 'assets/ui/create_char/intel_icon.png';
  static const String reduceBtn = 'assets/ui/create_char/reduce_btn.png';
  static const String addBtn = 'assets/ui/create_char/add_btn.png';
